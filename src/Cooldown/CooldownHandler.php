...
class CooldownHandler
{
    ...
    /**
     * Create a new cooldown session handler instance.
     *
     * @return void
     */
    ...
    /**
     * Push a cooldown record to into the session if doesn't exists.
     *
     * This method will remove all expired records.
     *
     ...
     * @return bool
     */
    public function push(CooldownRecord $cooldown): bool
    {
        $this->forgetExpiredViews($cooldown->baseKey());

        if (! $this->has($cooldown->key())) {
